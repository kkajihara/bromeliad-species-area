...
fung_asv_names <- lapply(list(fung_inv_regress_dat,
                              ...
                              fung_air_regress_dat),
                         get_asv_names,
                         asv_table = fung_data)

fung_asv_df <- as.data.frame(multi_merge_matrix(fung_asv_names))
names(fung_asv_df) <- c("Invertebrates", "Detritus", "Water", "Air")
...
fung_eul_plot <-  plot(fung_euler, quantities=TRUE, edges = FALSE, main = "Fungi",
                      fills=met.brewer("Paquin",4))

ggsave("../figures/for_manuscript/fung_venn.png", fung_eul_plot, width = 5, height=5)
ggsave("../figures/for_manuscript/fung_venn.pdf", fung_eul_plot, width = 5, height=5)


bact_asv_names <- lapply(list(bact_inv_regress_dat,
                              bact_det_regress_dat,
                              bact_water_regress_dat,
                              bact_air_regress_dat),
                         get_asv_names,
                         asv_table = bact_data)

bact_asv_df <- as.data.frame(multi_merge_matrix(bact_asv_names))
names(bact_asv_df) <- c("Invertebrates", "Detritus", "Water", "Air")
...
ggsave("../figures/for_manuscript/bact_venn.png", bact_eul_plot, width = 5, height=5)
ggsave("../figures/for_manuscript/bact_venn.pdf", bact_eul_plot, width = 5, height=5)
