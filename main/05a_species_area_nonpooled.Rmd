...
z_plot <- ggplot(slope_df, aes(fill=factor(compartment, levels = c("Detritus", "Water", "Invertebrates (d)", "Invertebrates (w)")), 
  ...
  scale_fill_manual(values = met.brewer("Cassatt1", 5)) +
  theme_minimal() +
  ...
  scale_y_continuous(breaks = c(-0.15, -0.1, -0.05, 0, 0.05, 0.1, 0.15),limits = c(c(-0.15, 0.15)))

ggsave("../figures/for_manuscript/z_score_plot2.pdf", width=8, height=5.5)
ggsave("../figures/for_manuscript/z_score_plot2.png", width=8, height=5.5)


# only significant SARs
sig_sar_df <- slope_df[c(2,5,6),]
z_plot_sig <- ggplot(sig_sar_df, aes(fill=factor(compartment, levels = c("Detritus", "Water")), 
                                y=slope, 
                                x=factor(locus, levels = c("Fungi", "Bacteria")))) + 
  ...
  scale_fill_manual(values = met.brewer("Cassatt1", 5)) +
   ...
   theme(axis.text = element_text(color = "black", size=12),
         ...
         legend.title = element_text(size = 14)) +
  labs(x = "Microbe", y = "z-score", fill = "Compartment") +
  scale_y_continuous(breaks = c(-0.1,0,0.1), limits = c(-0.113, 0.111), expand = c(0, 0))

ggsave("../figures/for_manuscript/z_score_plot3.pdf", width=8, height=5.5)
ggsave("../figures/for_manuscript/z_score_plot3.png", width=8, height=5.5)
```
